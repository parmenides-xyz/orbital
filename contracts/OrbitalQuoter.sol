...
contract OrbitalQuoter {
    ...
    function quoteSingle(QuoteSingleParams memory params)
        public
        returns (uint256 amountOut, uint128 sumReservesAfter, int24 tickAfter)
    {
    ...
    function quote(bytes memory path, uint256 amountIn)
        public
        returns (uint256 amountOut, uint128[] memory sumReservesAfterList, int24[] memory tickAfterList)
    {
        ...
        while (true) {
            ...
            (uint256 amountOut_, uint128 sumReservesAfter, int24 tickAfter) = quoteSingle(
                QuoteSingleParams({
